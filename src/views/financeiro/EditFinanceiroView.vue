              ...
              <div class="columns">
                ...
                <div class="column">
                  <div class="field">
                    ...
                    <div class="control">
                      <CmbTerritorio :id_prop="financeiro.id_prop" :tipo="9" @selTerr="financeiro.id_local = $event" :sel="financeiro.id_local"
...
export default {
  ...
  methods: {
    ...
    loadData() {
      ...
      financeiroService.getFinanceiro(this.financeiro.id_financeiro).then(
        (response) => {
          let data = response.data;
          this.financeiro.dt_cadastro = data.dt_cadastro;
          this.financeiro.id_local = data.id_local;
          this.financeiro.gasolina = data.gasolina;
          this.financeiro.alcool = data.alcool;
          this.financeiro.diesel = data.diesel;
          this.financeiro.pecas = data.pecas;
          this.financeiro.peca_viat = data.peca_viat;
          this.financeiro.manutencao = data.manutencao;
          this.financeiro.bens_mob = data.bens_mob;
          this.financeiro.outros_cons = data.outros_cons;
          this.financeiro.outros_serv = data.outros_serv;
    ...
    update() {
      ...
      if (!this.v$.$error) {
        ...
        financeiroService.update(this.financeiro).then(
          (response) => {
            this.showMessage = true;
            this.message = "Dados do financeiro alterados com sucesso.";
            this.type = "success";
            this.caption = "Servidor";
            setTimeout(() => (this.showMessage = false), 3000);
          },
  ...
  created() {
    this.financeiro.id_financeiro = this.$route.params.id;
    this.loadData();
  },
};
</script>
