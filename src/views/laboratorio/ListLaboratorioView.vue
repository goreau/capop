      ...
      <div class="column is-11">
        ...
        <div class="card">
          <header class="card-header">
            <p class="card-header-title is-centered">Atividades de Laboratório</p>
          ...
          {title: 'Ações', responsive: 0, minWidth: 250, 
            formatter: (cell, formatterParrams) =>{
              ...
              btEdit.addEventListener('click', () => {
                this.$router.push(`/editLaboratorio/${row.id_laboratorio}`);
              });
            ...
            /* const teste = document.createElement('div'); 
              ...
              if (ok) {
                laboratorioService.delete(row.id_laboratorio)
                .then(resp =>{
                  if (resp.status == '200'){
                    location.reload();
                  } else {
