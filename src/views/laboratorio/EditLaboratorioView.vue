          ...
          <div class="card-content">
            <div class="content">
              ...
              <div class="field">
                ...
                <div class="control">
                  <CmbServidor :id_prop="laboratorio.id_prop" :tipo="9" @selServ="laboratorio.id_servidor = $event" :sel="laboratorio.id_servidor"
...
export default {
  ...
  methods: {
    ...
    loadData() {
      ...
      laboratorioService.getLaboratorio(this.laboratorio.id_laboratorio).then(
        (response) => {
          let data = response.data;
          this.laboratorio.dt_cadastro = data.dt_cadastro;
          this.laboratorio.id_servidor = data.id_servidor;
          this.laboratorio.id_programa = data.id_programa;
          this.laboratorio.id_ativ_lab = data.id_ativ_lab;
          this.laboratorio.producao = data.producao;
    ...
    update() {
      ...
      if (!this.v$.$error) {
        ...
        laboratorioService.update(this.laboratorio).then(
          (response) => {
            this.showMessage = true;
            this.message = "Dados do laboratorio alterados com sucesso.";
            this.type = "success";
  ...
  created() {
    this.laboratorio.id_laboratorio = this.$route.params.id;
    this.loadData();
  },
};
</script>
